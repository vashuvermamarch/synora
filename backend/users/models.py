...
class Profile(models.Model):
    ...
    avatar_seed = models.CharField(max_length=100, blank=True, default='Felix')
...
class ContactRequest(models.Model):
    """Stores user-reported problems from the Contact Us page."""
    ...
    def __str__(self):
        return f"Support: {self.full_name} - {self.status}"
