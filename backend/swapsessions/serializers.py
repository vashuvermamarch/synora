...
class SessionSerializer(serializers.ModelSerializer):
    ...
    user1_avatar_seed = serializers.CharField(source='user1.profile.avatar_seed', read_only=True)
    user2_avatar_seed = serializers.CharField(source='user2.profile.avatar_seed', read_only=True)
    ...
    class Meta:
        ...
        fields = [
            ...
            'user1_avatar_seed', 'user2_avatar_seed',
...
class SwapRequestSerializer(serializers.ModelSerializer):
    ...
    sender_avatar_seed = serializers.CharField(source='sender.profile.avatar_seed', read_only=True)
    receiver_avatar_seed = serializers.CharField(source='receiver.profile.avatar_seed', read_only=True)

    class Meta:
        model = SwapRequest
        fields = ['id', 'sender', 'receiver', 'sender_name', 'receiver_name', 'sender_avatar_seed', 'receiver_avatar_seed', 'status', 'created_at']
